...
<table>
	...
	<tbody>
		<tr>
			<td>php.ini (date.timezone)</td>
			<td><?php if (ini_get('date.timezone')) { ?> <img src="img/icons/accept.png"> OK <?php } else { ?> <img src="img/icons/cancel.png"> Not set!<?php } ?> </td>
        </tr>
	</tbody>
</table>
<hr>
